...
router.get('/create/post', auth, isAdmin, newsController.GetCreate)
router.get('/edit/:id', auth, isAdmin, newsController.GetEdit)
router.get('/create/category', auth, isAdmin, newsController.GetCreateCategory)
router.get('/categories', auth, isAdmin, newsController.GetCategories)
